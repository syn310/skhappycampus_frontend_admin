...
import { Header, Grid, Form, Field, Table, Button, Dropdown,
    Label, Segment, Container, Checkbox, Icon, Input } from 'semantic-ui-react'
...
class RegisterContainer extends Component {
    ...
    validate = () =>{
        ...
        // console.log("a",agreeChk.checked)
    ...
    handleTextInputChange = (e) => {
        ...
        if(e.target.name === "inputId" || e.target.name === "customDomain"){
            this.setState({
                duplicatePass: false
            })
        }
    ...
    render() { 
        ...
        return ( 
            ...
            <Grid.Row>
                <Container>
                    <Form>
                        <Form.Field>
                            <label>아이디</label>
                            <input style={{"width":"155px"}} placeholder='아이디'  name="inputId" onChange={handleTextInputChange} /> <Icon name="at"/>
                            { customInput ? 
                            <input style={{"width":"200px"}} placeholder='ex) domain.com' name="customDomain" onChange={handleTextInputChange} /> :
                                <Dropdown id="selCategory" 
                                    name="domain" 
                                    onChange={handleInputChange}
                                    style={{"top":"1px","display":"inline-block", "width":"200px"}}
                                    selection
                                    fluid
                                    placeholder="도메인 선택"
                                    options={domainList}></Dropdown>
                            }
                            <span style={{"verticalAlign":"middle"}} className="margin_left_10">
                                <Checkbox onClick={handleCustomInput}/>
                            </span>
                            <Label style={{"color":"grey","fontWeight":"300"}} basic color="grey" pointing="left">
                                직접입력
                            </Label>
                            <span className="margin_left_5"><Button color="red" onClick={handleDuplicateCheck}>중복확인</Button></span>
                        </Form.Field>
                        <Form.Field>
                            <label>비밀번호 <span style={{"color":"red","fontWeight":"300"}}>*대문자, 소문자, 숫자가 각각 1개이상 포함 필수</span></label>
                            <input type="password" style={{"width":"380px"}} name="password" placeholder='비밀번호' onChange={handleTextInputChange} />
                        </Form.Field>
                        <Form.Field>
                            <label>비밀번호확인</label>
                            <input type="password" style={{"width":"380px"}} name="passwordConfirm" placeholder='비밀번호 확인' onChange={handleTextInputChange} />
                        </Form.Field>
                    </Form>
                </Container>
            </Grid.Row>
            <Grid.Row centered>
                {/* < style={{"border":"solid 1px", "height":"400px", "overflowY":"scroll"}}> */}
                <Segment textAlign="left" style={{"width":"1127px", "height":"450px", "overflowY":"scroll"}}>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 1조 (목적)</p>
                ...
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 2조 (정의)</p>
                ...
                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 3조 (회원 가입 신청 및 허가)</p>
                <p>&nbsp; 회원으로 가입하고자 하는 자는 회사가 제시하는 양식에 자기 정보를 입력, 신청하고 회사는 이를 허가함으로써 가입된 회원에게 서비스를 제공한다.</p>

                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 4조 (회원 가입 신청 시 기재 항목)</p>
                ...
                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 5조 (회원 가입 허가 및 유보 등)</p>
                ...
                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 6조 (회원 정보의 변경)</p>
                <p>&nbsp; 회원은 서비스의 이용 및 원활한 정보 제공 등을 위해 자기 정보를 성실히 관리해야 하며, 변동 사항이 있을 경우 이를 변경해야 한다.</p>

                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 7조 (회원 탈퇴 및 이용 제한)</p>
                ...
                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 8조 (정보 및 서비스의 제공 등)</p>
                ...
                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 9조 (회원 신상정보 관리 등 의무)</p>
                ...
                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 10조 (서비스 이용에 대한 회원의 의무)</p>
                ...
                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 11조 (게시 및 저장 자료에 대한 책임과 권리)</p>
                ...
                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 12 조 링크사이트</p>
                ...
                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 13 조 게시물</p>
                ...
                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 14조 (면책 및 손해 배상)</p>
                ...
                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 15조 (약관의 효력 및 변경)</p>
                ...
                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 16조 (약관 규정 외 사항에 관한 준칙)</p>
                <p>&nbsp; 본 약관에 규정되지 않은 사항에 대해서는 전기통신사업법 등 관계 법령의 규정을 따른다.</p>

                <p style={{textAlign:"left"}}><strong>&nbsp;</strong></p>
                <p style={{color:"#111", fontSize:"18px", fontWeight:"600"}}>제 17조 (관할 법원)</p>
            ...
            <Grid.Row centered>
                <div>
                    <span style={{"verticalAlign":"middle"}}  className="margin_left_5">
                        <Checkbox id="agreement"/>
                    </span>
                    <span> 이용약관 동의 </span><span style={{"color":"red","fontWeight":"400"}}>(필수)</span>
                </div>
            </Grid.Row>
            <Grid.Row centered>
                <Button onClick={handleRegisterClick} content='가입' icon='check' labelPosition='left' color="green"></Button>
                <Button className="margin_left_5" onClick={handleCancel} content="취소" icon="redo" labelPosition='left' color="grey"></Button>
            </Grid.Row>
